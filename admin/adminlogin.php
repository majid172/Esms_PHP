...
if(!isset($_SESSION['is_login'])){
	...
	if(isset($_REQUEST['email']))
	{
		...
		$sql="SELECT a_email, a_pass FROM admin WHERE a_email='".$u_email."' AND a_pass='".$u_pass."' limit 1";
		...
		if($result->num_rows==1)
		{
			...
			echo "<script>location.href='adminBoard.php';</script>";
			exit;
		}
		else{
...
<body>
	...
	<div class="container-fluid">
			...
			<form class="form-group border border-success col-md-5 mt-5 p-4" method="POST" >
				<h4 class="text-center text-black"><i class="fas fa-sign-in-alt pr-3"></i>Admin Login Form</h4>
