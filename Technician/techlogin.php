...
if(!isset($_SESSION['is_login'])){
	...
	if(isset($_REQUEST['email']))
	{
		...
		$sql="SELECT t_email, t_pass FROM technician WHERE t_email='".$u_email."' AND t_pass='".$u_pass."' limit 1";
		...
		if($result->num_rows==1)
		{
			...
			echo "<script>location.href='techDash.php';</script>";
			exit;
		}
		else{
...
<body>
	...
	<div class="container-fluid">
			...
			<form class="form-group border border-danger col-md-5 mt-5 p-4" method="POST" >
				<h4 class="text-center text-black"><i class="fas fa-sign-in-alt pr-3"></i>Technician Login Form</h4>
				...
				<?php 
					...
					<div class="row">
						<div class="col-lg-6">
							<button class="btn btn-outline-success form-control mt-3">Login</button>
						</div>
						...
						<div class="col-lg-12">
							<a href="techReg.php" class="btn btn-outline-danger form-control mt-3 pt-2">Technician Registration</a>
						</div>
