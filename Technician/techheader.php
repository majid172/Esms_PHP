			...
			<div class="col-sm-2 sidebar bg-dark">
				<div class="sidebar-sticky">
					<ul class="nav flex-column ">
						<li class="nav-item text-light"><a  href="techDash.php" class="nav-link <?php if(PAGE=='userProfile'){ echo 'active';}?> mt-5 pt-5 text-light"><i class="far fa-user pr-2"></i>Profile</a></li>
						...
						<li class="nav-item text-light"><a href="techlogout.php" class="nav-link text-light pt-3"><i class="fas fa-sign-out-alt pr-2"></i>Logout</a></li>
					</ul>
				</div>
			</div>
